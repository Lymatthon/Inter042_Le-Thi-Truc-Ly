...
<div class="container">
    ...
    <form action="/customer" method="post">
        ...
        <div class="form-group">
            ...
            <input type="date" name="customer_birthday" value="<c:out value='${Customer.customer_birthday}' />">

        </div>
        <br>
        <div class="form-group">
            <label>Gender</label>
            <select name="customer_gender" value="<c:out value='${Customer.customer_gender}' />" >
